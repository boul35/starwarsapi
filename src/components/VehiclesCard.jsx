...
{ const [data,setData] = useState([]);
 ...
 {data.map(data => <div className="cards2"> <h2>{data.name}</h2>  <h3>{data.model}</h3> <h4>{data.manufacturer}</h4>   <Link to={`/vehicles/${ data.url.split('/')[5]}`}><h2>Lien vers le Vehicules</h2></Link></div> 
